        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
          ...
          <div>
            ...
            <p className="text-xl text-on-surface mb-10 leading-relaxed">
              Contact us today if you have any questions for the officer team!
            </p>

            <h3 className="text-xl font-bold mb-6 font-display">
              Alpine Race Club at OSU <br />
              2026 - 2027 Officers
            </h3>

            <div className="space-y-4 text-on-surface">
              <p><span className="font-bold">President:</span> Cooper Andrus</p>
              <p><span className="font-bold">Treasurer:</span> Cooper Tillson</p>
              <p><span className="font-bold">Communications:</span> Kate Grey</p>
              <p><span className="font-bold">Media Manager:</span> Miles Kemph</p>
              
              <p><span className="font-bold">Email:</span> <a href="mailto:contact@arc-at-osu.org" className="hover:underline">contact@arc-at-osu.org</a></p>
              <p><span className="font-bold">Find us on Instagram:</span> <a href="https://www.instagram.com/osu.alpine/" target="_blank" rel="noopener noreferrer" className="hover:underline">@osu.alpine</a></p>
            </div>
          </div>

          {/* Right Column: Contact Form */}
          <div>
            <form action="https://formsubmit.co/contact@arc-at-osu.org" method="POST" className="space-y-6">
              <input type="hidden" name="_subject" value="New Submission from ARC Website Contact Form" />
